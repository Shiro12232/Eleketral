...
// --- DADOS APENAS DAS PEÇAS & KITS ---
const pecasCatalogo = [
  { id: 1, nome: ' a1', categoria: 'a1', preco: 'R$ ?', imagem: '/fundoInicio_upscaled.png', descricao: 'descrição.' },
  { id: 2, nome: 'a2"', categoria: 'a2', preco: 'R$ ?', imagem: '/fundoInicio_upscaled.png', descricao: 'descrição.' },
  { id: 3, nome: 'a3', categoria: 'a3', preco: 'R$ ?', imagem: '/fundoInicio_upscaled.png', descricao: 'descrição' },
...
export default function CatalogoPage() {
  ...
  const categoriasPecas = ['Todos', 'Kits', 'Rodas & Pneus', 'Performance', 'Suspensão', 'Freios', 'Exterior',];
  ...
  return (
    <div className="min-h-screen bg-[#0b0b0f] text-white pt-24 pb-16 px-4 md:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Cabeçalho limpo focado apenas nas Peças */}
        ...
        <div className="flex flex-col md:flex-row gap-12 mt-8">
          ...
          {/* Lateral Esquerda: Filtros de Peças */}
            ...
            <div className="flex flex-col gap-2">
              {categoriasPecas.map((cat) => (
                <button
                  ...
                  className={`text-left px-4 py-3 transition-all border ${
                    filtroCategoria === cat
          ...
          <main className="flex-grow">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {itensFiltrados.map((item) => {
                ...
                return (
                  <div 
                    key={item.id} 
                    className="bg-zinc-900/60 border border-purple-500/20 flex flex-col justify-between hover:border-purple-500/60 transition-all group"
                  >
                    <div className="relative w-full h-48 bg-zinc-950 overflow-hidden flex items-center justify-center">
                      ...
                      />
                      <span className="absolute top-2 left-2 bg-purple-600 text-white text-[10px] font-bold px-2 py-1 uppercase tracking-wider">
                        {item.categoria}
                      </span>
                    </div>
                    ...
                    <div className="p-5 pt-0 flex items-center justify-between mt-2">
                      ...
                      <Link 
                        href={linkHref} 
                        className="bg-purple-600/10 hover:bg-purple-600 border border-purple-500/30 text-white text-xs font-bold px-3 py-2 transition-all text-center"
                      >
                        ADICIONAR
                      </Link>
                    </div>
            ...
            {itensFiltrados.length === 0 && (
              <div className="text-center text-gray-500 py-20 border border-zinc-800/50 bg-zinc-900/20">
