...
export function Buildcar() {
  // Os 3 passos simples para o usuário montar o carro
  const steps = [
    {
      stepNumber: "01",
  ...
  return (
    <section className="relative w-full py-24 bg-[#0b0b0f] text-white overflow-hidden border-t border-gray-900">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[300px] bg-gradient-to-r from-purple-700/15 to-blue-600/15 blur-[120px] rounded-full pointer-events-none -z-0" />
      ...
      <div className="container px-4 mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto mb-12">
          {steps.map((item, index) => (
            <div
              key={index}
              className="bg-[#121218]/80 backdrop-blur-md border border-gray-800/80 rounded-2xl p-8 flex flex-col justify-between transition-all duration-300 hover:-translate-y-1 hover:border-purple-500/40 group shadow-xl"
            >
              <div>
                {/* Número do passo e ícone */}
        ...
        <div className="text-center">
          <Link
            ...
            className="inline-flex items-center gap-2 bg-purple-600 hover:bg-purple-700 text-white font-bold px-8 py-4 rounded-xl shadow-lg shadow-purple-900/30 transition-all duration-300 hover:scale-105 cursor-pointer"
          >
            COMEÇAR AGORA
